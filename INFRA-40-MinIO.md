...
```bash
aws-cli/1.42.50 Python/3.10.12 Linux/5.15.148-tegra botocore/1.40.50
```
...
```bash
aws --endpoint-url http://192.168.178.84:9000 s3 ls --profile minio
```
...
2. Configurar alias:
```bash
mc alias set local http://192.168.178.84:9000 minioclaudia minioclaudia
```
...
```bash
mc alias set bronze http://192.168.178.84:9000 claudia_bronze claudia_bronze
mc ls bronze
```
...
```bash
mc alias set bronze http://192.168.178.84:9000 claudia_bronze claudia_bronze
mc alias set silver http://192.168.178.84:9000 claudia_silver claudia_silver
mc alias set gold http://192.168.178.84:9000 claudia_gold claudia_gold
```
...
```bash
aws --profile minio --endpoint-url http://192.168.178.84:9000 s3 ls
```
